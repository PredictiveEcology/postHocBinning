...
head(birdDatasets$meanOVEN) #demonstrate what the first few lines of one of the birdDatasets looks like
```
...
head(birdStatsByClass$meanOVEN) #demonstrate what first lines of a birdStatsByClass df looks like
```
...
plotMeanBirdDensity <- ggplot(data = singleBirdStats, aes(x = uniqueClasses, y = meanBirdDensity, fill = forestedStatus)) +
